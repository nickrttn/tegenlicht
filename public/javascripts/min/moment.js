...
!function (a, b) {
  ...
  function a() {
    ...
    var c, d, e;if (m(b._isAMomentObject) || (a._isAMomentObject = b._isAMomentObject), m(b._i) || (a._i = b._i), m(b._f) || (a._f = b._f), m(b._l) || (a._l = b._l), m(b._strict) || (a._strict = b._strict), m(b._tzm) || (a._tzm = b._tzm), m(b._isUTC) || (a._isUTC = b._isUTC), m(b._offset) || (a._offset = b._offset), m(b._pf) || (a._pf = j(b)), m(b._locale) || (a._locale = b._locale), $c.length > 0) for (c in $c) {
    ...
    var b,
        c,
        d = a.match(ed);for (b = 0, c = d.length; c > b; b++) {
    ...
    }var d = 5;for (fd.lastIndex = 0; d >= 0 && fd.test(a);) {
    ...
    if (b._f === a.ISO_8601) return void ma(b);b._a = [], j(b).empty = !0;var c,
        ...
        h = "" + b._i,
        i = h.length,
        k = 0;for (e = V(b._f, b._locale).match(ed) || [], c = 0; c < e.length; c++) {
    ...
    }), za(b)) : "object" == (typeof f === "undefined" ? "undefined" : _typeof(f)) ? Ea(b) : "number" == typeof f ? b._d = new Date(f) : a.createFromInputFallback(b);
    ...
    var d, e;if (1 === b.length && c(b[0]) && (b = b[0]), !b.length) return Ja();for (d = b[0], e = 1; e < b.length; ++e) {
