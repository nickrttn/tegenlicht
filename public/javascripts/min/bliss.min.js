...
!function () {
  ...
  function t(e, r, i) {
    return r = void 0 === r ? 1 : r, i = i || r + 1, 1 >= i - r ? function () {
      if (arguments.length <= r || "string" === n.type(arguments[r])) return e.apply(this, arguments);var t,
          i = arguments[r];for (var o in i) {
        var s = Array.from(arguments);s.splice(r, 1, o, i[o]), t = e.apply(this, s);
      }return t;
    } : t(t(e, r + 1, i), r, i - 1);
  }function e(t, e, r) {
    for (var i in e) {
      if (r) {
        var o = n.type(r);if ("own" === r && !e.hasOwnProperty(i) || "array" === o && -1 === r.indexOf(i) || "regexp" === o && !r.test(i) || "function" === o && !r.call(e, i)) continue;
      }var s = Object.getOwnPropertyDescriptor(e, i);!s || s.writable && s.configurable && s.enumerable && !s.get && !s.set ? t[i] = e[i] : (delete t[i], Object.defineProperty(t, i, s));
    }return t;
    ...
    return "string" === n.type(t) ? (e || document).querySelector(t) : t || null;
      ...
      };i["super"] = t["extends"] || null, i.prototype = n.extend(Object.create(i["super"] ? i["super"].prototype : Object), { constructor: i });var o = function o(t) {
        return this.hasOwnProperty(t) && -1 === e.indexOf(t);
      };if (t["static"]) {
        n.extend(i, t["static"], o);for (var s in n.classProps) {
          s in t["static"] && n.classProps[s](i, t["static"][s]);
        }
      }n.extend(i.prototype, t, o);for (var s in n.classProps) {
        s in t && n.classProps[s](i.prototype, t[s]);
    ...
    this.subject = t, this.data = {}, this.bliss = {};
      ...
      return e = +e || 400, new Promise(function (r, i) {
        if ("transition" in this.style) {
          var o = n.extend({}, this.style, /^transition(Duration|Property)$/);n.style(this, { transitionDuration: (e || 400) + "ms", transitionProperty: Object.keys(t).join(", ") }), n.once(this, "transitionend", function () {
            clearTimeout(s), n.style(this, o), r(this);
          });var s = setTimeout(r, e + 50, this);n.style(this, t);
      ...
      (t || "").split(/\s+/).forEach(function (t) {
        if (r in this && (t.indexOf(".") > -1 || !e)) {
          t = (t || "").split(".");var n = t[1];t = t[0];var i = this[r].bliss.listeners = this[r].bliss.listeners || {};for (var o in i) {
            if (!t || o === t) for (var s, a = 0; s = i[o][a]; a++) {
              n && n !== s.className || e && e !== s.callback || (this.removeEventListener.call(this, o, s.callback, s.capture), a--);
            }
          }
      ...
      if (t && t.addEventListener) {
        var e = this;if (t[r] && t[r].bliss) {
          var i = t[r].bliss.listeners;for (var o in i) {
            i[o].forEach(function (t) {
              e.addEventListener(o, t.callback, t.capture);
            });
          }
        }for (var s in t) {
          0 === s.indexOf("on") && (this[s] = t[s]);
        }
      } else if (arguments.length > 1 && "string" === n.type(t)) {
        var a = arguments[1],
            c = arguments[2];t.split(/\s+/).forEach(function (t) {
    ...
    r = n.extend({ $: !0, element: !0, array: !0 }, r), "function" == n.type(e) && (!r.element || t in n.Element.prototype && i || (n.Element.prototype[t] = function () {
      ...
      var e = [].slice.apply(arguments),
          i = e.shift(),
          o = r.array && Array.isArray(i) ? "Array" : "Element";return n[o].prototype[t].apply({ subject: i }, e);
    })));
  ...
  if (Bliss && !Bliss.shy) {
    var e = Bliss.property;if (t.add({ clone: function clone() {
      ...
      } }, { array: !1 }), Object.defineProperty(Node.prototype, e, { get: function s() {
        return Object.defineProperty(Node.prototype, e, { get: void 0 }), Object.defineProperty(this, e, { value: new t.Element(this) }), Object.defineProperty(Node.prototype, e, { get: s }), this[e];
      ...
      var n = EventTarget.prototype.addEventListener,
        ...
        if (this && this[e] && r) {
          var s = this[e].bliss.listeners = this[e].bliss.listeners || {};if (t.indexOf(".") > -1) {
            t = t.split(".");var a = t[1];t = t[0];
          }s[t] = s[t] || [], 0 === s[t].filter(i.bind(null, r, o)).length && s[t].push({ callback: r, capture: o, className: a });
        }return n.call(this, t, r, o);
      }, EventTarget.prototype.removeEventListener = function (t, n, i) {
        if (this && this[e] && n) {
          var s = this[e].bliss.listeners = this[e].bliss.listeners || {};s[t] && (s[t] = s[t].filter(o.bind(null, n, i)));
